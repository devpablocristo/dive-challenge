...
func (h *RestHandler) GetLTP(c *gin.Context) {
	// Implementar la lógica para recuperar el Último Precio Negociado
	// Puedes llamar a funciones de servicios, adaptadores, etc.
	// Aquí es donde se integraría con la API de Kraken o cualquier otra fuente de datos.
